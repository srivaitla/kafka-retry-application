...
@Component
public class RetryKafkaConsumer1 {

    private static final Logger LOGGER = LogManager.getLogger(RetryKafkaConsumer1.class);

    private static final String CONSUMER_NAME = "Retry-Consumer-1";
    ...
    @KafkaListener(topics = "${kafka.retry.topic1}", groupId = "${spring.kafka.consumer.group-id1}")
    public void consumeRetryTopic1(ConsumerRecord<String, RetryRequest> record) {
